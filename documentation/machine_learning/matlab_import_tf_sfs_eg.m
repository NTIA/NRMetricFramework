...
% indices obtained from feature selection
...
modelFolder = "vcrdci123_sfs_small_model";
...
featureTestData = readtable("feature_test_vcrdci123_sfs_small.csv");
featureTestData = featureTestData(2:end,:);

predictions = predict(net, featureTestData);    
predictions;
tf_predictions = fileread("predictions_sfs.txt");
